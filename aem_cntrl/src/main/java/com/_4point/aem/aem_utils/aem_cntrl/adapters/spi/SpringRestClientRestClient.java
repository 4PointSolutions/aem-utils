...
public class SpringRestClientRestClient implements RestClient {
	...
	@Override
	public Builder multipartPayloadBuilder(String additionalPath) {
		return new RestClientMultipartPayloadBuilder(additionalPath);
	}
	...
	private final class RestClientMultipartPayloadBuilder extends SpringClientRequestBuilder implements MultipartPayload.Builder {
		...
		private RestClientMultipartPayloadBuilder() {
		}

		private RestClientMultipartPayloadBuilder(String additionalPath) {
